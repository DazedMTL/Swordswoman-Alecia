...
(function () {
   ...
   */
  const _Sprite_Character_startDynamicSvMotion =
    Sprite_Character.prototype.startDynamicSvMotion;
   ...
   * ※DRQ_EventMotionsの関数
   */
  const _Game_CharacterBase_playCustomMotion =
    Game_CharacterBase.prototype.playCustomMotion;
   ...
   * ●モーションパターンの更新
   */
  const _Game_CharacterBase_updatePattern =
